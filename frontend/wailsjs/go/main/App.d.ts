...
import {janitor} from '../models';

export function AppVersion():Promise<string>;

export function CheckForUpdate():Promise<appupdate.Info>;
...
export function InstallUpdate():Promise<appupdate.Result>;
...
export function ReclaimSpace(arg1:string):Promise<janitor.Result>;
